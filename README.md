...
Samples for the Trend Micro Deep Security SDK. The examples in the [Automation Center](https://automation.deepsecurity.trendmicro.com) guides are based on these samples.

Samples for each programming language are located in the python, javascript, and java folders. 

## Branches

The master branch of this repository corresponds with the current DSaaS version of Deep Security.  
