...
def set_allow_agent_initiated_activation(api, configuration, api_version, api_exception, allow):
    ...
    setting_name = "platform_setting_agent_initiated_activation_enabled"
    system_settings_class = getattr(api.models, "SystemSettings")
    friendly_setting_name = system_settings_class.attribute_map[setting_name]
    ...
    try:
        ...
        return system_settings_api.modify_system_setting(friendly_setting_name, allow_value, api_version)
